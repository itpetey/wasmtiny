...
impl SpecRunner {
    ...
    fn with_fixtures_dir(mut self, dir: PathBuf) -> Self {
        self.fixtures_dir = dir;
        self
    }

    fn with_backends(mut self, backends: Vec<Backend>) -> Self {
        self.enabled_backends = backends;
        self
    }

    fn with_skip_features(mut self, features: Vec<SkipReason>) -> Self {
    ...
    fn should_skip_file(&self, spec_file: &str) -> Option<SkipReason> {
    ...
    fn run_spec_file(&self, spec_file: &str) -> Result<Vec<SpecResult>, String> {
    ...
    fn compare_results(&self, results: &[SpecResult]) -> bool {
        if results.is_empty() {
            return true;
        }
...
mod tests {
    ...
    #[test]
    fn test_spec_const() {
        let result = run_spec_test("const.wast");
        assert!(
    ...
    #[test]
    fn test_spec_i32() {
        let result = run_spec_test("i32.wast");
        assert!(
            matches!(result, SpecTestResult::Passed | SpecTestResult::Failed(_)),
            "Expected pass or fail, got {:?}",
            result
    ...
    #[test]
    fn test_spec_f32() {
        let result = run_spec_test("f32.wast");
        assert!(
            matches!(result, SpecTestResult::Passed | SpecTestResult::Failed(_)),
            "Expected pass or fail, got {:?}",
            result
    ...
    #[test]
    fn test_spec_block() {
        let result = run_spec_test("block.wast");
        assert!(
            matches!(result, SpecTestResult::Passed | SpecTestResult::Failed(_)),
            "Expected pass or fail, got {:?}",
            result
    ...
    #[test]
    fn test_spec_br() {
        let result = run_spec_test("br.wast");
        assert!(
            matches!(result, SpecTestResult::Passed | SpecTestResult::Failed(_)),
            "Expected pass or fail, got {:?}",
            result
    ...
    #[test]
    fn test_spec_br_if() {
        let result = run_spec_test("br_if.wast");
        assert!(
            matches!(result, SpecTestResult::Passed | SpecTestResult::Failed(_)),
            "Expected pass or fail, got {:?}",
            result
    ...
    fn test_spec_br_table() {
        let result = run_spec_test("br_table.wast");
        assert!(
            matches!(result, SpecTestResult::Passed | SpecTestResult::Failed(_)),
            "Expected pass or fail, got {:?}",
            result
    ...
    #[test]
    fn test_spec_call() {
        let result = run_spec_test("call.wast");
        assert!(
            matches!(result, SpecTestResult::Passed | SpecTestResult::Failed(_)),
            "Expected pass or fail, got {:?}",
            result
    ...
    fn test_spec_call_indirect() {
        let result = run_spec_test("call_indirect.wast");
        assert!(
            matches!(result, SpecTestResult::Passed | SpecTestResult::Failed(_)),
            "Expected pass or fail, got {:?}",
            result
    ...
    fn test_spec_conversions() {
        let result = run_spec_test("conversions.wast");
        assert!(
            matches!(result, SpecTestResult::Passed | SpecTestResult::Failed(_)),
            "Expected pass or fail, got {:?}",
            result
    ...
    fn test_spec_local_get() {
        let result = run_spec_test("local_get.wast");
        assert!(
            matches!(result, SpecTestResult::Passed | SpecTestResult::Failed(_)),
            "Expected pass or fail, got {:?}",
            result
    ...
    #[test]
    fn test_spec_loop() {
        let result = run_spec_test("loop.wast");
        assert!(
            matches!(result, SpecTestResult::Passed | SpecTestResult::Failed(_)),
            "Expected pass or fail, got {:?}",
            result
    ...
    #[test]
    fn test_spec_memory() {
        let result = run_spec_test("memory.wast");
        assert!(
            matches!(result, SpecTestResult::Passed | SpecTestResult::Failed(_)),
            "Expected pass or fail, got {:?}",
            result
    ...
    #[test]
    fn test_spec_table() {
        let result = run_spec_test("table.wast");
        assert!(
            matches!(result, SpecTestResult::Passed | SpecTestResult::Failed(_)),
            "Expected pass or fail, got {:?}",
            result
