    ...
    fn execute_opcode(&mut self, opcode: u8) -> Result<()> {
        match opcode {
            ...
            0x42 => {
                ...
                self.operand_stack.push(WasmValue::I64(val));
            }
            0x43 => {
                let val = self.operand_stack.pop_f32()?;
                self.operand_stack.push(WasmValue::F32(val));
            }
            0x44 => {
                let val = self.operand_stack.pop_f64()?;
                self.operand_stack.push(WasmValue::F64(val));
            }
            0x45 => {
                let val = self.operand_stack.pop_i32()?;
                self.operand_stack
                    .push(WasmValue::I32(if val == 0 { 1 } else { 0 }));
            }
            0x46 => {
                let b = self.operand_stack.pop_i32()?;
                let a = self.operand_stack.pop_i32()?;
                self.operand_stack
                    .push(WasmValue::I32(if a == b { 1 } else { 0 }));
            }
            0x47 => {
                let b = self.operand_stack.pop_i32()?;
                let a = self.operand_stack.pop_i32()?;
            ...
            0x6D => {
                ...
                self.operand_stack.push(WasmValue::I32(a.wrapping_div(b)));
            }
            0x6E => {
                let b = self.operand_stack.pop_i32()?;
                let a = self.operand_stack.pop_i32()?;
            ...
            0x76 => {
                ...
                let a = self.operand_stack.pop_i32()?;
                self.operand_stack
                    .push(WasmValue::I32((a as i32 >> b) as u32 as i32));
            }
            0x77 => {
                let val = self.operand_stack.pop_i32()?;
                self.operand_stack
                    .push(WasmValue::I32(val.count_ones() as i32));
            }
            0x78 => {
                let val = self.operand_stack.pop_i32()?;
                self.operand_stack
                    .push(WasmValue::I32(val.count_zeros() as i32));
            }
            0x79 => {
                let val = self.operand_stack.pop_i32()?;
                self.operand_stack
                    .push(WasmValue::I32(val.leading_zeros() as i32));
            }
            0x7A => {
                let val = self.operand_stack.pop_i32()?;
                self.operand_stack
                    .push(WasmValue::I32(val.trailing_zeros() as i32));
            }
            0x7B => {
            ...
            0x85 => {
                let val = self.operand_stack.pop_f32()?;
                self.operand_stack.push(WasmValue::F32(val.abs()));
            }
            0x86 => {
                let val = self.operand_stack.pop_f32()?;
                self.operand_stack.push(WasmValue::F32(-val));
            ...
            0x87 => {
                let val = self.operand_stack.pop_f32()?;
                self.operand_stack.push(WasmValue::F32(val.ceil()));
            }
            0x88 => {
                let val = self.operand_stack.pop_f32()?;
                self.operand_stack.push(WasmValue::F32(val.floor()));
            }
            0x89 => {
                let val = self.operand_stack.pop_f32()?;
                self.operand_stack.push(WasmValue::F32(val.trunc()));
            }
            0x8A => {
                let val = self.operand_stack.pop_f32()?;
                self.operand_stack.push(WasmValue::F32(val.sqrt()));
            }
            0x8B => {
            ...
            0x8F => {
                let b = self.operand_stack.pop_f32()?;
                let a = self.operand_stack.pop_f32()?;
                self.operand_stack.push(WasmValue::F32(a.min(b)));
            }
            0x90 => {
                let b = self.operand_stack.pop_f32()?;
                let a = self.operand_stack.pop_f32()?;
                self.operand_stack.push(WasmValue::F32(a.max(b)));
            }
            0xA0 => {
                let val = self.operand_stack.pop_f64()?;
                self.operand_stack.push(WasmValue::F64(val.abs()));
            }
            0xA1 => {
                let val = self.operand_stack.pop_f64()?;
                self.operand_stack.push(WasmValue::F64(-val));
            ...
            0xA2 => {
                let val = self.operand_stack.pop_f64()?;
                self.operand_stack.push(WasmValue::F64(val.ceil()));
            }
            0xA3 => {
                let val = self.operand_stack.pop_f64()?;
                self.operand_stack.push(WasmValue::F64(val.floor()));
            }
            0xA4 => {
                let val = self.operand_stack.pop_f64()?;
                self.operand_stack.push(WasmValue::F64(val.trunc()));
            }
            0xA5 => {
                let val = self.operand_stack.pop_f64()?;
                self.operand_stack.push(WasmValue::F64(val.sqrt()));
            }
            0xA6 => {
            ...
            0xAA => {
                let b = self.operand_stack.pop_f64()?;
                let a = self.operand_stack.pop_f64()?;
                self.operand_stack.push(WasmValue::F64(a.min(b)));
            }
            0xAB => {
                let b = self.operand_stack.pop_f64()?;
                let a = self.operand_stack.pop_f64()?;
                self.operand_stack.push(WasmValue::F64(a.max(b)));
            }
            0xAC => {
                let b = self.operand_stack.pop_i32()?;
                let a = self.operand_stack.pop_i32()?;
                self.operand_stack
                    .push(WasmValue::I32(a.wrapping_shl(b as u32)));
            }
            0xAD => {
                let b = self.operand_stack.pop_i32()?;
                let a = self.operand_stack.pop_i32()?;
                self.operand_stack
                    .push(WasmValue::I32((a as u32).wrapping_shr(b as u32) as i32));
            }
            0xAE => {
                let b = self.operand_stack.pop_i64()?;
                let a = self.operand_stack.pop_i64()?;
                self.operand_stack
                    .push(WasmValue::I64(a.wrapping_shl(b as u32)));
            }
            0xAF => {
                let b = self.operand_stack.pop_i64()?;
                let a = self.operand_stack.pop_i64()?;
                self.operand_stack
                    .push(WasmValue::I64((a as u64).wrapping_shr(b as u32) as i64));
            }
            0xB0 => {
                let val = self.operand_stack.pop_i32()?;
                self.operand_stack
            ...
            0xB4 => {
                let val = self.operand_stack.pop_i64()?;
                self.operand_stack
                    .push(WasmValue::I64(val.count_ones() as i64));
            }
            0xB5 => {
                let val = self.operand_stack.pop_i64()?;
                self.operand_stack
                    .push(WasmValue::I64(val.count_zeros() as i64));
            }
            0xB6 => {
                let val = self.operand_stack.pop_i64()?;
                self.operand_stack
                    .push(WasmValue::I64(val.leading_zeros() as i64));
            }
            0xB7 => {
                let val = self.operand_stack.pop_i64()?;
                self.operand_stack
                    .push(WasmValue::I64(val.trailing_zeros() as i64));
            }
            0xD0 => {
                self.operand_stack.push(WasmValue::NullRef);
            }
            0xD1 => {
...
mod tests {
    ...
    fn test_i32_operations() {
        ...
        interp.operand_stack.push(WasmValue::I32(5));
        interp.operand_stack.push(WasmValue::I32(3));
    ...
    fn test_bit_operations() {
        let mut interp = Interpreter::new();
        interp.operand_stack.push(WasmValue::I32(0b1100));
        interp.operand_stack.push(WasmValue::I32(0b1010));
